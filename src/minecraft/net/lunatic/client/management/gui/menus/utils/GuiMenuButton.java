package net.lunatic.client.management.gui.menus.utils;

import net.lunatic.client.management.utils.render.Colors;
...
public class GuiMenuButton extends GuiButton {
    ...
    public GuiMenuButton(int buttonId, int x, int y, int widthIn, int heightIn, String buttonText) {
        ...
        icon = new ResourceLocation("lunatic/menus/mainmenu/icons/" + displayString.toLowerCase() + ".png");
    }
    ...
    public void drawButton(Minecraft mc, int mouseX, int mouseY) {
        if (this.visible) {
            ...
            Minecraft.getMinecraft().fontRendererObj.drawStringWithShadow(displayString, 50 / 2 - (Minecraft.getMinecraft().fontRendererObj.getStringWidth(displayString) / 2), 55, text);
